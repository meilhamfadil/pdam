        ...
        <form id="form" method="POST" action="<?= base_url("devices/save") ?>" role="form">
            ...
            <div class="card-body">
                <div class="form-group row">
                    <label for="nama_device" class="col-sm-2 col-form-label text-right">Nama Device</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama_device" name="nama_device" value="<?= $nama_device ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nama_file" class="col-sm-2 col-form-label text-right">Nama File</label>
                    <div class="col-sm-10">
